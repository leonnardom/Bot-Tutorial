...
exports.run = async(client, message, args) => {
    ...
    .setAuthor(`Central de Ajuda do Bot`, client.user.displayAvatarURL({size: 2048}))
    ...
    if(args[0]) {
        ...
        if(!comando) {
            return message.quote(`${message.author}, não achei nenhum comando com o nome/aliases **\`${name}\`**.`)
        }
